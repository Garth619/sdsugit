<?php
/**
 * Template Name: Tribal Star Training Dates
 *
...
<?php $tstrainingdates= new WP_Query( array( 'post_type' => 'tribalstarevents','order' => 'DSC' ) ); while($tstrainingdates->have_posts()) : $tstrainingdates->the_post(); ?>
