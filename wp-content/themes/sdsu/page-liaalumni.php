...
yoast_breadcrumb('<span class="breadcrumbs">','</span>');
			...
			<div class="content_wrapper">
				<div id="content">
					...
					<hr/>
					<?php $liaalumni= new WP_Query( array( 'post_type' => 'liaalumni','order' => 'ASC' ) ); while($liaalumni->have_posts()) : $liaalumni->the_post(); ?>
					<?php include('my-alumni-loop.php'); ?>
					 <?php endwhile; ?>
