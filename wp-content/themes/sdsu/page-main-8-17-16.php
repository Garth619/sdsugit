...
<div class="main_inner">
	<div class="main_col main_col_1">
		<a href="<?php bloginfo( 'url' ); ?>/20th-anniversary"><img class="main_page_logos afpe" alt="Academy For Professional Excellence" style="max-width:264px" src="<?php bloginfo( 'template_directory' ); ?>/images/newlogo.jpg"/></a>
		...
		<div class="testimonial">
			...
			<?php if (!is_handheld()) : ?>
				...
				<?php if(get_field('rotating_testimonials')): ?>
					...
					<div class="cycle-slideshow" data-cycle-slides="> .testimonial_content" data-cycle-timeout="0" data-cycle-auto-height=container data-cycle-swipe=true data-cycle-swipe-fx=fade>
