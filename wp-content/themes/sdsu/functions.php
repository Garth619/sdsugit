...
function exclude_posts_from_edit_restrictions($post_type) {
  ...
  $restrict_it = true;
  if (current_user_can('pcwtauser')) {
      if ($post_type=='pcwtacurriculum') {
	        $restrict_it = false;
      }
  }
...
if(function_exists('acf_add_options_page')) {
	...
	acf_add_options_sub_page('Program Sidebar');
	acf_add_options_sub_page('Footer');

}


// this will spit out the child menu items in the sidbebar of each page. It will put them on the root page or the children pages
