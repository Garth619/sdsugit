...
*/
					...
					echo	'<img style="max-width:264px"  alt="Academy For Professional Excellence Health and Human Services" class="main_page_logos afpe" src="' . get_bloginfo( 'template_directory' ) . '/images/theacademy-logo.jpg"/>';
					 ?>
