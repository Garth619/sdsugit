...
<title><?php
	...
	?></title>
<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,300italic,300,400italic,700,700italic,800,800italic' rel='stylesheet' type='text/css'> 
		...
		<header role="banner">
			<div class="top">
				<div class="top_wrap">
					...
					<a class="top_login" title="Employee Login" href="<?php bloginfo( 'url' ); ?>/academy-login">Staff Login</a>
			...
			<div class="menu_wrapper">
				<div class="inner_menu">
										<?php
if (is_mobile() || is_tablet() || is_handheld()) : ?>
					...
					<!-- <a title="Browse Through Our Programs" class="menu_text" href="#mobile_menu">Menu</a> -->
