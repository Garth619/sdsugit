...
<div id="wrapper" class="hfeed">
   ...
   <nav id="desktop_menu">
		...
		<div class="menu-header intranet_header">
			<ul>
				<li><a class="intranet_menu_item_1" href="<?php bloginfo( 'url' ); ?>/staff-intranet/all-staff">All Staff</a></li>
				<li><a class="intranet_menu_item_2" href="<?php bloginfo( 'url' ); ?>/staff-intranet/new-staff">New Staff</a></li>
			</ul>
		</div><!-- menu-header -->
	</nav><!-- desktop menu -->
