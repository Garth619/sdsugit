<?php
/**
 * Template Name: Handouts Inner Pages
 *
...
yoast_breadcrumb('<span class="breadcrumbs">','</span>');
			...
			<div class="content_wrapper">
				<div id="content">
					...
					<h2 style="color:#000;">Evaluations</h2>
					
					
				<?php the_field('evualtions_description');?>
					
					
					<?php if(get_field('evaluations_handouts')): ?>
 
						<div class="handout_inner_wrapper">
						
						<?php while(has_sub_field('evaluations_handouts')): ?>
					...
					<h2 style="color:#000;">Handouts</h2>
					
					
				<?php the_field('handouts_description');?>
					
					
					<?php if(get_field('handouts_repeater')): ?>
 
						<div class="handout_inner_wrapper">
						
						<?php while(has_sub_field('handouts_repeater')): ?>
					...
					<h2 style="color:#000;">Websites</h2>
					
					
				<?php the_field('websites_description');?>
					
					
					<?php if(get_field('websites_repeater')): ?>
 
						<div class="handout_inner_wrapper">
						
						<?php while(has_sub_field('websites_repeater')): ?>
