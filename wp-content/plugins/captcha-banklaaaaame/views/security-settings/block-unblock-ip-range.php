...
else
{
	...
	elseif(security_settings_captcha_bank == "1")
	{
		...
		$captcha_manage_view_ip_range = wp_create_nonce("captcha_manage_view_ip_ranges");
										...
										foreach ($manage_ip_range_date as $row)
										{
											...
											<tr>
												<td style="text-align: center;">
													<input type="checkbox" onclick="check_all_captcha_bank('#ux_chk_all_manage_ip_range');" name="ux_chk_manage_ip_range_<?php echo $row["meta_id"]; ?>" id="ux_chk_manage_ip_range_<?php echo $row["meta_id"]; ?>" value="<?php echo $row["meta_id"]; ?>">
												</td>
												<td>
													<label>
