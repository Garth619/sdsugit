...
else
{
	...
	{
		$font_value = isset($meta_data_array["text_font"])? $meta_data_array["text_font"]:"";
		$signature_font_value = isset($meta_data_array["signature_font"])? $meta_data_array["signature_font"]:"";
												...
												<div class="input-icon-custom right">
													<select class="form-control custom-input-medium input-inline valid" id="ux_ddl_text_style_value" name="ux_ddl_text_style[]">
														...
														for($flag = 0; $flag <= 99; $flag++)
														{
															...
															{
																$disable = $flag == 24 ? "" : "disabled=disabled";
																?>
													...
													<input type="text" disabled="disabled" name="ux_ddl_text_style[]" id="ux_ddl_text_color"  class="form-control custom-input-medium input-inline valid" onblur="check_color_captcha_bank('#ux_ddl_text_color')" onfocus="cpb_colorpicker(this.id,this.value)" value="<?php echo isset($meta_data_array["text_style"]) ? ($text_style[1]) : "#cccccc" ;?>" placeholder="<?php echo $cpb_color_code; ?>">
												</div>
											</div>
										</div>
									</div>
											...
											<div class="form-group">
												...
												<select name="ux_ddl_text_font" id="ux_ddl_text_font" class="form-control">
														...
														foreach($web_font_list as $key => $value)
														{
															...
															$text = "disabled";
															?>
																<option value="<?php echo $key; ?>" <?php if(isset($text)) echo $text;  ?>><?php echo $value; ?></option>
															<?php
														}
														?>
												</select>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" disabled="disabled" name="ux_txt_signature_text" id="ux_txt_signature_text" value="<?php echo isset($meta_data_array["signature_text"]) ? $meta_data_array["signature_text"] : "";?>" placeholder="<?php echo $cpb_captcha_bank_signature_text_palceholder; ?>">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
												...
												<div class="input-icon-custom right">
													<select class="form-control custom-input-medium input-inline valid" name="ux_txt_signature_style[]" id="ux_ddl_signature_style_value">
														...
														for($flag = 0; $flag <= 99; $flag++)
														{
															if($flag < 10)
															{
																$disable_sign = $flag == 7 ? "" : "disabled=disabled";
																?>
