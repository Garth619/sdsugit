...
else
{
	...
	else
	{
		...
		if(!defined("captcha_settings_captcha_bank")) define("captcha_settings_captcha_bank","$full_control[1]");
		if(!defined("general_settings_captcha_bank")) define("general_settings_captcha_bank","$full_control[2]");
		if(!defined("logs_captcha_bank")) define("logs_captcha_bank","$full_control[3]");
		if(!defined("other_settings_captcha_bank")) define("other_settings_captcha_bank","$full_control[4]");
		if(!defined("security_settings_captcha_bank")) define("security_settings_captcha_bank","$full_control[5]");
		if(!defined("system_information_captcha_bank")) define("system_information_captcha_bank","$full_control[6]");
		if(!defined("error_logs_captcha_bank")) define("error_logs_captcha_bank","$full_control[6]");
		...
		if($flag == "1")
		{
			...
			add_submenu_page("captcha_bank",$cpb_captcha_setup_menu,$cpb_captcha_settings_label,"read","captcha_bank","captcha_bank");
			add_submenu_page($cpb_display_settings_title,$cpb_display_settings_title,"","read","captcha_bank_display_settings","captcha_bank_display_settings");

			add_submenu_page("captcha_bank",$cpb_notification_setup_label,$cpb_general_settings_menu,"read","captcha_bank_notifications_setup","captcha_bank_notifications_setup");
			add_submenu_page($cpb_message_settings_label,$cpb_message_settings_label,"","read","captcha_bank_message_settings","captcha_bank_message_settings");
			add_submenu_page($cpb_email_templates_menu,$cpb_email_templates_menu,"","read","captcha_bank_email_templates","captcha_bank_email_templates");
			add_submenu_page($cpb_roles_and_capabilities_menu,$cpb_roles_and_capabilities_menu,"","read","captcha_bank_roles_capabilities","captcha_bank_roles_capabilities");

			add_submenu_page("captcha_bank",$cpb_recent_login_log_title,$cpb_logs_menu,"read","captcha_bank_login_logs","captcha_bank_login_logs");
			add_submenu_page($cpb_visitor_logs_title,$cpb_visitor_logs_title,"","read","captcha_bank_visitor_logs","captcha_bank_visitor_logs");
			add_submenu_page($cpb_live_traffic_title,$cpb_live_traffic_title,"","read","captcha_bank_live_traffic","captcha_bank_live_traffic");
			add_submenu_page("captcha_bank",$cpb_other_settings_menu,$cpb_other_settings_menu,"read","captcha_bank_other_settings","captcha_bank_other_settings");
			add_submenu_page("captcha_bank",$cpb_blockage_settings_label,$cpb_security_settings_label,"read","captcha_bank_blockage_settings","captcha_bank_blockage_settings");
			add_submenu_page($cpb_block_unblock_ip_address_label,$cpb_block_unblock_ip_address_label,"","read","captcha_bank_block_unblock_ip_addresses","captcha_bank_block_unblock_ip_addresses");
			add_submenu_page($cpb_block_unblock_ip_range_label,$cpb_block_unblock_ip_range_label,"","read","captcha_bank_block_unblock_ip_ranges","captcha_bank_block_unblock_ip_ranges");
			add_submenu_page($cpb_block_unblock_countries_label,	$cpb_block_unblock_countries_label,"","read","captcha_bank_block_unblock_countries","captcha_bank_block_unblock_countries");
			add_submenu_page("captcha_bank",$cpb_feature_requests,$cpb_feature_requests,"read","captcha_bank_feature_requests","captcha_bank_feature_requests");
			add_submenu_page("captcha_bank",$cpb_system_information_menu,$cpb_system_information_menu,"read","captcha_bank_system_information","captcha_bank_system_information");
			add_submenu_page("captcha_bank",$cpb_error_logs,$cpb_error_logs,"read","captcha_bank_error_logs","captcha_bank_error_logs");
			add_submenu_page("captcha_bank",$cpb_premium_editions_menu,$cpb_premium_editions_menu,"read","captcha_bank_premium_editions","captcha_bank_premium_editions");
		}
		...
		*/
		...
		if(!function_exists("captcha_bank_display_settings"))
		{
		...
		*/
		...
		if(!function_exists("captcha_bank_login_logs"))
		{
		...
		*/
		...
		if(!function_exists("captcha_bank_visitor_logs"))
		{
		...
		*/
		...
		if(!function_exists("captcha_bank_live_traffic"))
		{
		...
		*/
		...
		if(!function_exists("captcha_bank_block_unblock_ip_ranges"))
		{
		...
		*/
		...
		/*
		Function Name: captcha_bank_error_logs
		Parameters: No
		Description: This function is used for creating captcha_bank_error_logs menu.
		Created On: 4-01-2017 17:00
		Created By: Tech Banker Team
		*/

		if(!function_exists("captcha_bank_error_logs"))
		{
			function captcha_bank_error_logs()
			{
				global $wpdb;
				$user_role_permission = get_users_capabilities_captcha_bank();
				if(file_exists(CAPTCHA_BANK_DIR_PATH."includes/translations.php"))
				...
				if(file_exists(CAPTCHA_BANK_DIR_PATH."views/error-logs/error-logs.php"))
				{
					include_once CAPTCHA_BANK_DIR_PATH."views/error-logs/error-logs.php";
				}
				if(file_exists(CAPTCHA_BANK_DIR_PATH."includes/footer.php"))
				{
					include_once CAPTCHA_BANK_DIR_PATH."includes/footer.php";
		...
		*/
		...
		if(!function_exists("captcha_bank_premium_editions"))
		{
