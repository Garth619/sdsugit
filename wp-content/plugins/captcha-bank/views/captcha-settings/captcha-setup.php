									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="ux_txt_signature_text" id="ux_txt_signature_text" disabled="disabled" value="<?php echo isset($meta_data_array["signature_text"]) ? $meta_data_array["signature_text"] : "";?>" placeholder="<?php echo $cpb_captcha_bank_signature_text_palceholder; ?>">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
