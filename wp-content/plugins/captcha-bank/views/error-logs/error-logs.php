								...
								<div class="form-body">
									...
									<div class="form-actions">
										<div class="pull-right">
											<a href="<?php echo content_url("wp-captcha-bank/error-logs.txt");?>" download="error-logs.txt" type="button" class="btn vivid-green" id="ux_btn_download" name="ux_btn_download"><?php echo $cpb_error_logs_download ;?></a>
