						...
						<form id="ux_frm_error_message">
							<div class="form-body">
								...
								<div class="form-group">
									...
									<textarea class="form-control" name="ux_txt_attempts" id="ux_txt_attempts"  placeholder="<?php echo $cpb_error_message_login_failure_placeholder;?>"><?php echo isset($error_messages_unserialize_data["for_login_attempts_error"]) ? $error_messages_unserialize_data["for_login_attempts_error"] : "";?></textarea>
								</div>
								<div class="form-group">
									<label class="control-label">
									...
									<textarea class="form-control" name="ux_txt_invalid" id="ux_txt_invalid"  placeholder="<?php echo $cpb_error_message_invalid_captcha_placeholder;?>"><?php echo isset($error_messages_unserialize_data["for_invalid_captcha_error"]) ? $error_messages_unserialize_data["for_invalid_captcha_error"] : "";?></textarea>
								</div>
								<div class="form-group">
									<label class="control-label">
									...
									<textarea class="form-control" name="ux_txt_ip_address" id="ux_txt_ip_address"  placeholder="<?php echo $cpb_error_message_blocked_ip_address_placeholder;?>"><?php echo isset($error_messages_unserialize_data["for_blocked_ip_address_error"]) ? $error_messages_unserialize_data["for_blocked_ip_address_error"] : "";?></textarea>
								</div>
								<div class="form-group">
									<label class="control-label">
									...
									<textarea class="form-control" name="ux_txt_empty" id="ux_txt_empty"  placeholder="<?php echo $cpb_error_message_empty_captcha_placeholder;?>"><?php echo isset($error_messages_unserialize_data["for_captcha_empty_error"]) ? $error_messages_unserialize_data["for_captcha_empty_error"] : "";?></textarea>
								</div>
								<div class="form-group">
									<label class="control-label">
									...
									<textarea class="form-control" name="ux_txt_ip_range" id="ux_txt_ip_range"  placeholder="<?php echo $cpb_error_message_blocked_ip_range_placeholder;?>"><?php echo isset($error_messages_unserialize_data["for_blocked_ip_range_error"]) ? $error_messages_unserialize_data["for_blocked_ip_range_error"] : "";?></textarea>
								</div>
								<div class="form-group">
									<label class="control-label">
