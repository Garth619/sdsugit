										...
										<div class="table-margin-top">
											<table class="table table-striped table-bordered table-hover" id="ux_tbl_other">
												...
												<tbody>
													...
													<tr>
														<td>
															<input type="checkbox" name="ux_chk_error_logs_others" id="ux_chk_error_logs_others" value="1" <?php echo isset($others) && $others[7] =="1" ? "checked = checked" : ""?>>
															<?php echo $cpb_error_logs;?>
														</td>
														<td>
														</td>
		...
		<div class="page-bar">
			<ul class="page-breadcrumb">
				<li>
					<i class="icon-custom-home"></i>
					<a href="admin.php?page=captcha_bank">
						<?php echo $cpb_captcha_bank_breadcrumb; ?>
					</a>
					<span>></span>
				</li>
				<li>
