                            ...
                            <div class="form-body">
                                ...
                                if ($live_traffic_data_unserialize["live_traffic_monitoring"] == "enable") {
                                    ...
                                    <div class="table-top-margin">
                                        <select name="ux_ddl_live_traffic" id="ux_ddl_live_traffic" class="custom-bulk-width" onChange="captcha_bank_show_time_for('#ux_ddl_live_traffic', '#ux_ddl_live_traffic_block_for');">
                                        ...
                                        <select name="ux_ddl_live_traffic_block_for" id="ux_ddl_live_traffic_block_for"  style="display:none" class="custom-bulk-width">
                                            ...
                                            foreach ($cpb_data_logs as $row) {
                                                ...
                                                <tr>
                                                    <td style="text-align: center;width: 5% !important;">
                                                        <input type="checkbox" onclick="check_all_captcha_bank('#ux_chk_live_traffic');" name="ux_chk_details_<?php echo intval($row["meta_id"]) ?>" id="ux_chk_details_<?php echo intval($row["meta_id"]) ?>" value="<?php echo intval($row["meta_id"]) ?>">
                                                    </td>
                                                    <td style="width: 15%;">
                                                        <label>
                                                    ...
                                                    <td style="width: 25%;">
                                                        <label>
                                                            <?php echo $cpb_resources; ?>: <?php echo esc_attr($row["resources"]); ?><br/>
                                                            <?php echo $cpb_http_user_agent; ?>: <?php echo esc_attr($row["http_user_agent"]); ?>
                                                        </label>
                                                    </td>
                                                    <td style="width: 15%;">
                                                        <label>
                                                    ...
                                                    <td class="custom-alternative" style="width: 10%;">
                                                        <a href="javascript:void(0);" class="icon-custom-trash tooltips" data-original-title="<?php echo $cpb_delete; ?>" onclick='delete_selected_log_captcha_bank(<?php echo intval($row["meta_id"]); ?>, <?php echo json_encode($cpb_delete_live_traffic); ?>, "admin.php?page=captcha_bank_live_traffic");' data-placement="top"></a>
