										...
										foreach($cpb_data_logs as $row)
										{
											...
											<tr>
												...
												<td class="custom-alternative" style="width: 10%;">
													<a href="javascript:void(0);" class="icon-custom-trash tooltips" data-original-title="<?php echo $cpb_delete; ?>" onclick='delete_selected_log_captcha_bank(<?php echo $row["meta_id"];?>,<?php echo json_encode($cpb_delete_login_logs); ?>,"admin.php?page=captcha_bank_login_logs")' data-placement="top"></a>
