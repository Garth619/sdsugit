									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" class="form-control" name="ux_txt_login" id="ux_txt_login" maxlength="4" value="<?php echo isset ($blocking_options_unserialized_data["maximum_login_attempt_in_a_day"]) ? $blocking_options_unserialized_data["maximum_login_attempt_in_a_day"] : "" ?>"  onfocus="paste_only_digits_captcha_bank(this.id);" placeholder="<?php echo $cpb_blocking_options_login_attempts_placeholder;?>">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
