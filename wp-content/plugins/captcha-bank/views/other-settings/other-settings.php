								...
								<div class="form-body">
										...
										<div class="col-md-6">
											<div class="form-group">
												<label class="control-label">
													<?php echo $cpb_other_settings_automatic_plugin_updates;?> :
													<i class="icon-custom-question tooltips" data-original-title="<?php echo $cpb_other_settings_automatic_plugin_updates_tooltip;?>" data-placement="right"></i>
													<span class="required" aria-required="true">*</span>
												</label>
												<select name="ux_ddl_plugin_updates" id="ux_ddl_plugin_updates" class="form-control">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												<label class="control-label">
													<?php echo $cpb_other_settings_error_reporting;?> :
													<i class="icon-custom-question tooltips" data-original-title="<?php echo $cpb_other_settings_error_reporting_tooltip;?>" data-placement="right"></i>
													<span class="required" aria-required="true">*</span>
												</label>
												<select name="ux_ddl_other_settings_error_reporting" id="ux_ddl_other_settings_error_reporting" class="form-control">
													<option value="enable"><?php echo $cpb_enable;?></option>
													<option value="disable"><?php echo $cpb_disable;?></option>
												</select>
											</div>
