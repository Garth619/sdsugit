...
else
{
	...
	else
	{
		...
		<script type="text/javascript">
			...
			if(typeof(open_popup_captcha_bank) != "function")
			{
			...
			if(typeof(show_pop_up_captcha_bank) != "function")
			{
					...
					case "captcha_bank_other_settings" :
						...
						if(other_settings_captcha_bank == "1")
						{
							...
							jQuery(document).ready(function()
							{
								...
								jQuery("#ux_ddl_other_settings_error_reporting").val("<?php echo isset($meta_data_array["other_settings_error_reporting"]) ? $meta_data_array["other_settings_error_reporting"] : "" ?>");
