...
else
{
	...
	else
	{
		...
		if(array_key_exists("$locale",$wp_langs))
		{
			...
			$cpb_message_translate_help = __("If you would like to translate in $language & help us, we will reward you with a free Personal Edition License of Captcha Bank.","captcha-bank");
			$cpb_kindly_click = __("If Interested, Kindly click ","captcha-bank");
		...
		$cpb_other_settings_error_reporting = __("Error Reporting","captcha-bank");
		$cpb_other_settings_error_reporting_tooltip = __("If you would like to Report your Errors in Error Logs Menu, then you would need to Choose Enable from dropdown or vice-versa","captcha-bank");
		...
		$cpb_clear_error_logs_success = __("Error log has been cleared Successfully","captcha-bank");
	}
}
?>
